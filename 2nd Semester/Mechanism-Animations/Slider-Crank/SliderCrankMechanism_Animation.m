...
for index = 1:length(thetaRadiansArray)
    ...
    sliderPointsXArray = [pointC(1)-40  pointC(1)-40  pointC(1)+40  pointC(1)+40  pointC(1)-40];
    sliderPointsYArray = [pointC(2)-20  pointC(2)+20  pointC(2)+20  pointC(2)-20  pointC(2)-20];
    
    plot([pointA(1) pointB(1)], [pointA(2) pointB(2)], 'r-o');
    hold on;
    plot([pointB(1) pointC(1)], [pointB(2) pointC(2)], 'b-o');
    plot(sliderPointsXArray, sliderPointsYArray, 'm-');
