...
pointLT = [-0.5*breadth;  0.5*height; 1]; pointRT = [0.5*breadth;  0.5*height; 1]; %last row as 1
pointLB = [-0.5*breadth; -0.5*height; 1]; pointRB = [0.5*breadth; -0.5*height; 1]; %last row as 1
...
uPointInFrame2 = [1; 0; 1]; vPointInFrame2 = [0; 1; 1]; %1 as last row, HTM
...
plot([pointLBInFrame1(1) pointLTInFrame1(1) pointRTInFrame1(1) pointRBInFrame1(1) pointLBInFrame1(1)],...
     [pointLBInFrame1(2) pointLTInFrame1(2) pointRTInFrame1(2) pointRBInFrame1(2) pointLBInFrame1(2)], 'b');
